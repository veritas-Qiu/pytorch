...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_normal_(at::Tensor & self, double mean, double std, c10::optional<at::Generator> generator);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_uniform_(at::Tensor & self, double from, double to, c10::optional<at::Generator> generator);
